...
struct StubNetworkClinet: NetworkRounting {
...
class MoviesLoaderTests: XCTestCase {
    func testSuccessLoading() {
        let stubNetworkClient = StubNetworkClinet(emulateError: false)
    ...
    func testFailureLoading() {
        let stubNetworkClient = StubNetworkClinet(emulateError: true)
        let loader = MoviesLoader(networkClient: stubNetworkClient)
